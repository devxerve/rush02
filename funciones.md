...
* parse_dict: Trocea el texto bruto (: y \n) y rellena un array de t_dict con pares clave/valor limpios.-<<<-CESAR--/
...
* ISA process_number: Procesa un bloque de 3 dígitos imprimiendo su centena, decena y unidad individual.
* ANDRES print_scale: Imprime el nombre de la escala ("thousand", "million") justo después de un bloque que no sea cero.
